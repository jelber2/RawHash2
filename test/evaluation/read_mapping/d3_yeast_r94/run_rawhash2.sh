...
#d3_yeast_r94
OUTDIR="./rawhash2/"
SIGNALS="../../../data/d3_yeast_r94/fast5_files/"
...
PREFIX="d3_yeast_r94"
bash ../../../scripts/run_rawhash2.sh ${OUTDIR} ${PREFIX} ${SIGNALS} ${REF} ${PORE} ${PRESET} ${THREAD} > "${OUTDIR}/${PREFIX}_rawhash2_${PRESET}.out" 2> "${OUTDIR}/${PREFIX}_rawhash2_${PRESET}.err"

#Minimizers
PREFIX="d3_yeast_r94_w3"
PARAMS="-w 3"
