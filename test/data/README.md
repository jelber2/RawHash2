...
bash download_d4_green_algae.sh #Download Dataset D4 Green Algae
...
```bash
bash download_d2_ecoli_r94.sh    #Download E. coli (R9.4) for Rawsamble
bash download_d3_yeast.sh        #Download Yeast (R9.4) for Rawsamble
bash download_d4_green_algae.sh  #Download Green Algae (R9.4) for Rawsamble
bash download_d9_ecoli_r1041.sh  #Download E. coli (R10.4.1) for Rawsamble
```