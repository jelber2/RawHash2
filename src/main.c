...
int main(int argc, char *argv[])
{
        ...
        if (argc == o.ind || fp_help == stdout) {
                ...
                fprintf(fp_help, "                        Bypasses event detection; values are z-scored\n");
                fprintf(fp_help, "                        automatically using per-read signal statistics.\n");
                fprintf(fp_help, "                        Format: read_id<TAB>ev1 ev2 ... evN (pA means per segment)\n");
